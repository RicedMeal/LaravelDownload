        ...
        <nav class="text-sm font-medium text-gray-500" aria-label="Main Navigation">
            <nav class="text-sm font-medium text-gray-500" aria-label="Main Navigation">
                ...
                <div x-data="{ open: false }">
                    <div @click="open = !open" class="flex items-center justify-between px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200" role="button">
                    ...
                    <div x-show="open" class="ml-7">
                        <a class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200" href="{{ route('projects.create') }}">
                            <span>Create Project</span>
                        </a>
                        <a class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200" href="{{ route('projects.index') }}">
                            <span>Drafts</span>
                        </a>
                        <a class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200" href="#">
                            <span>Completed</span>
        ...
        <header class="flex items-center justify-between w-full px-4 h-14">
            ...
            <div x-data="{ isOpen: false }" class="relative inline-block">
                <div class="flex items-center ml-5">
                    <div @click="isOpen = !isOpen" class="flex items-center bg-white border-0 py-2 px-2 focus:outline-none transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200 rounded-md">
