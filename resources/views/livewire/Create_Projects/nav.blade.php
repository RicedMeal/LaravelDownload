            ...
            <nav class="text-sm font-medium text-gray-500" aria-label="Main Navigation">
                ...
                <div x-data="{ open: localStorage.getItem('submenuOpen') === 'true' || true }" x-init="() => { open = open }">
                    ...
                    <div x-show="open" class="ml-7">
                        <a class="flex items-center px-4 py-3 transition cursor-pointer group hover:bg-gray-800 hover:text-gray-200 {{ request()->routeIs('create-project') ? 'bg-gray-800 text-gray-200' : '' }}" href="{{ route('create-project') }}">
